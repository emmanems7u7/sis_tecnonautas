...
<head>
    <meta charset="utf-8">
    <title>Tecnonautas</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="Tecnonautas" name="keywords">
    <meta content="Tecnonautas" name="description">
    ...
    <!-- Flaticon Font -->
    <link href="{{ asset('estilos_inicial/lib/flaticon/font/flaticon.css')}}" rel="stylesheet">


    <!-- Libraries Stylesheet -->
    <link href="{{ asset('estilos_inicial/lib/owlcarousel/assets/owl.carousel.min.css')}}" rel="stylesheet">
    <link href="{{ asset('estilos_inicial/lib/lightbox/css/lightbox.min.css')}}" rel="stylesheet">

    <!-- Customized Bootstrap Stylesheet -->
    <link href="{{ asset('estilos_inicial/css/style.css')}}" rel="stylesheet">
</head>
...
<body>
    ...
    <div class="container-fluid bg-light position-relative shadow">
        <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0 px-lg-5">
            <a href="" class="navbar-brand font-weight-bold text-secondary" style="font-size: 50px;">
                <img src="{{ asset('imagenes/tecnonautas.png') }}" alt="" style="width: 48px;">
                <span class="text-primary">Tecnonautas</span>
            </a>
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                <div class="navbar-nav font-weight-bold mx-auto py-0">
                    ...
                    <a href="class.html" class="nav-item nav-link">Materias</a>
    ...
    <div class="container-fluid bg-primary px-0 px-md-5 mb-5">
        <div class="row align-items-center px-3">
            ...
            <div class="col-lg-6 text-center text-lg-right">
                <img class="img-fluid mt-5" src="{{ asset('imagenes/tecnonautas.png') }}" alt="">
            </div>
        </div>
    </div>
    <!-- Header End -->
    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-7">
                    <p class="section-title pr-5"><span class="pr-2">Sobre nosotros</span></p>
                    <h1 class="mb-4">El Mejor lugar para tus Hijos</h1>
    ...
    <div class="container-fluid pt-5">
        <div class="container">
            <div class="text-center pb-2">
                <p class="section-title px-5"><span class="px-2">Nuestras Materias</span></p>
                <h1 class="mb-4">Materias Disponibles</h1>
            </div>
            <div class="row">
    ...
    <div class="container-fluid py-5">
        <div class="container p-0">
            <div class="text-center pb-2">
                <p class="section-title px-5"><span class="px-2">Mensaje</span></p>
                <h1 class="mb-4">Que dicen nuestros miembros de la empresa</h1>
            </div>
        ...
        <div class="row pt-5">
            <div class="col-lg-3 col-md-6 mb-5">
                <a href="" class="navbar-brand font-weight-bold text-primary m-0 mb-4 p-0"
                    ...
                    <span class="text-white">Tecnonautas</span>
                </a>
    ...
    <script src=" {{ asset('estilos_inicial/lib/easing/easing.min.js')}}"></script>
    <script src=" {{ asset('estilos_inicial/lib/owlcarousel/owl.carousel.min.js')}}"></script>
    <script src=" {{ asset('estilos_inicial/lib/isotope/isotope.pkgd.min.js')}}"></script>
    <script src=" {{ asset('estilos_inicial/lib/lightbox/js/lightbox.min.js')}}"></script>

    <!-- Contact Javascript File -->
    <script src=" {{ asset('estilos_inicial/mail/jqBootstrapValidation.min.js')}}"></script>
    <script src=" {{ asset('estilos_inicial/mail/contact.js')}}"></script>

    <!-- Template Javascript -->
    <script src=" {{ asset('estilos_inicial/js/main.js')}}"></script>
</body>
