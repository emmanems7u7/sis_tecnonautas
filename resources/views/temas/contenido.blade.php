            ...
            <div class=" accordion" id="accordionExample">
                ...
                @if($temas !== null)
                    @foreach($temas as $index => $tema)
                        <div class="card">
                            <div class="card-header card-c" id="heading{{ $index }}" style="height: 72px;">
                                <h5 class="mb-0">
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        ...
                                                        @elseif($contenido->tipo === 'video')
                                                            ...
                                                            <a href="#" data-bs-toggle="modal" data-bs-target="#modalVideo{{ $contenido->id }}">
                                                                {{ $contenido->nombre }}
                                                            </a>
                                                                ...
                                                                <div class="modal-dialog modal-lg modal-dialog-centered">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title" id="modalVideoLabel{{ $contenido->id }}">
                                                                                {{ $contenido->nombre }}
                                                                            </h5>
                ...
                @if(auth()->user()->hasRole('admin') || auth()->user()->hasRole('profesor'))
                    <div class="card" style="height: 72px;">
                        <div class="card-header card-c" id="">
                            <h5 class="mb-0">
                                <button class="text-white btn btn-link" data-toggle="collapse" onclick="openModal()">
                                    Crear Tema
                                </button>
                            </h5>
                        </div>
