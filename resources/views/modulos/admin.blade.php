...
@section('content')
    @if(Auth::user()->hasRole('admin') || Auth::user()->hasRole('profesor'))
        ...
        <div class="alert alert-info" role="alert" style="text-align: justify; font-size: 11px;">
            <h5 class="alert-heading">Información sobre la Gestión de Estudiantes</h5>

            <p style="font-size: 13px !important;"><strong>Estudiantes Inscritos:</strong> En esta sección podrá visualizar a
                los
            ...
            <p style="font-size: 13px !important;"><strong>Notas de Estudiantes:</strong> Desde aquí puede acceder a:</p>
            <ul>
            ...
            <p style="font-size: 13px !important;"><strong>Reporte de Asistencia:</strong> Esta opción le permite generar un
                informe
                completo sobre
                la asistencia registrada de cada estudiante en el módulo correspondiente.</p>

            <p style="font-size: 13px !important;"><strong>Importante:</strong> La acción de asignar al siguiente módulo solo
                será
        ...
        <div class="row align-items-md-stretch mt-2">
            ...
            <div id="miContenedor" class="row align-items-md-stretch ">
                <div class="col">
                        ...
                        <div class="table-responsive">
                            ...
                            <table id="tabla-estudiantes"
                                class=" table-sm table table-striped""
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        style="
                                display: none; background-color: #fdfdfd;">
        ...
        <script>
                ...
                fetch('{{ route('studiantes.ver', ['id_a' => $id_a, 'id_p' => $id_p]) }}').then(response => response.json())
                    .then(data => {
                        ...
                        estudiantes.forEach(function (estudiante) {
                            ...
                            var fotoPerfilUrl = "{{ asset('/storage') }}" + estudiante.fotoperfil;
                            ...
                            celdaApellido.textContent = estudiante.apepat + ' ' + estudiante.apemat;
                ...
                fetch("{{ route('notasEstudiantes.ver', ['id_a' => $id_a, 'id_m' => $id_m, 'id_p' => $id_p]) }}")
                    ...
                    .then(data => {
                        ...
                        if (data.tareas && data.tareas.length > 0) {
                            ...
                            tareasHeader.style.backgroundColor = '#f8f9fa'; // Color de fondo para las tareas
                        ...
                        evaluacionesHeader.style.backgroundColor = '#e9ecef'; // Color de fondo para las evaluaciones
                        ...
                        data.tareas.forEach(tarea => {
                            ...
                            header.style.backgroundColor = '#f8f9fa'; // Color de fondo para las tareas
                            header.style.textAlign = 'center'; // Alinear el texto al centro
                        ...
                        data.evaluaciones.forEach(evaluacion => {
                            ...
                            header.style.backgroundColor = '#e9ecef'; // Color de fondo para las evaluaciones
                            header.style.textAlign = 'center'; // Alinear el texto al centro
                            subHeaderRow.appendChild(header);
                        });
                        ...
                        accionesHeader.style.backgroundColor = '#f0f0f0'; // Color de fondo para la columna de acciones
                        ...
                        data.estudiantesTareas.forEach(item => {
                            ...
                            allTareasIds.forEach(tareaId => {
                                ...
                                if (tarea) {
                                    ...
                                    tareaCell.textContent = 'No realizado';
                                }
                            ...
                            allEvaluacionesIds.forEach(evaluacionId => {
                                ...
                                if (evaluacion) {
                                    ...
                                    evaluacionCell.textContent = 'No realizado';
                                }
                            ...
                            celdaAcciones.innerHTML = `
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    <a href="${'{{ route('estudiante.detalle', ['id' => ':id', 'id_m' => $id_m]) }}'.replace(':id', item.user_id)}" class="btn btn-sm btn-primary mb-1">Detalles</a>
            ...
            function datosPersonal(idEstudiante) {
                ...
                var datay = url.replace('id_est', idEstudiante);
                ...
                fetch(datay)
                    ...
                    .then(data => {
                        ...
                        const nombreEstudiante = data.usuario.name + ' ' + data.usuario.apepat + ' ' + data.usuario.apemat;
                        const nombreParalelo = data.paralelo.nombre;
                        const nombreModulo = data.nombreMod.nombreM;
                        const profesor = data.profesor.name + ' ' + data.profesor.apepat + ' ' + data.profesor.apemat;
                        ...
                        const imagenEstudiante = `{{ asset('/storage${data.usuario.fotoperfil}') }}`;
            ...
            function confirmarAsignacion(estudiante_id) {
                Swal.fire({
                    icon: 'question',
                    title: '¿Estás seguro?',
                    text: '¿Deseas asignar al estudiante al siguiente modulo?',
                        ...
                        fetch(url, {
                            ...
                            .catch(error => {
                                Swal.fire({
                                    icon: 'error',
                                    title: 'Error',
                                    text: 'Hubo un problema al asignar.'
                                });
                            });
                    }
                });
