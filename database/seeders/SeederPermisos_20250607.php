...
class SeederPermisos_20250607 extends Seeder
{
    ...
    {
        $permisos = [
            ['id' => '161', 'name' => 'contenido._tema_eliminar', 'tipo' => 'permiso', 'guard_name' => 'web', 'id_relacion' => null],
            ...
            ['id' => '149', 'name' => 'modulos.temas_eliminar_contenido', 'tipo' => 'permiso', 'guard_name' => 'web', 'id_relacion' => null],
            ['id' => '148', 'name' => 'modulos.temas_obtener', 'tipo' => 'permiso', 'guard_name' => 'web', 'id_relacion' => null],
            ['id' => '147', 'name' => 'modulos.temas_guardar_contenido', 'tipo' => 'permiso', 'guard_name' => 'web', 'id_relacion' => null],
            ['id' => '146', 'name' => 'modulos.temas_guardar', 'tipo' => 'permiso', 'guard_name' => 'web', 'id_relacion' => null],
            ['id' => '145', 'name' => 'modulos.temas_crear', 'tipo' => 'permiso', 'guard_name' => 'web', 'id_relacion' => null],
            ['id' => '144', 'name' => 'modulos.temas_eliminar', 'tipo' => 'permiso', 'guard_name' => 'web', 'id_relacion' => null],
            ['id' => '143', 'name' => 'modulos.temas_actualizar', 'tipo' => 'permiso', 'guard_name' => 'web', 'id_relacion' => null],
            ['id' => '142', 'name' => 'modulos.temas_editar', 'tipo' => 'permiso', 'guard_name' => 'web', 'id_relacion' => null],
            ['id' => '141', 'name' => 'modulos.temas_finalizar', 'tipo' => 'permiso', 'guard_name' => 'web', 'id_relacion' => null],
            ['id' => '140', 'name' => 'modulos.temas_detalles', 'tipo' => 'permiso', 'guard_name' => 'web', 'id_relacion' => null],
            ['id' => '139', 'name' => 'modulos.temas_contenido', 'tipo' => 'permiso', 'guard_name' => 'web', 'id_relacion' => null],
            ['id' => '138', 'name' => 'modulos.temas_administrar', 'tipo' => 'permiso', 'guard_name' => 'web', 'id_relacion' => null,],
